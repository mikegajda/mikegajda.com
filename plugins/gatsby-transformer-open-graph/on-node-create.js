...
module.exports = async function onCreateNode(
  ...
  const { createNode, createParentChildLink } = actions //console.log("onCreateNode node=", node)
  ...
  console.log('conent=', content) // let data = grayMatter(content, pluginOptions)
  ...
  opengraphNode.og = {
    ogUrl: `https://cdn.vox-cdn.com/thumbor/oQHsce6Ez49l4rdP4QbHa-PIetE=/0x0:2040x1360/1220x813/filters:focal(857x517:1183x843):format(webp)/cdn.vox-cdn.com/uploads/chorus_image/image/61115509/acastro_180416_1777_chrome_0001.0.jpg`,
